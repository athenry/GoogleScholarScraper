# File-Name: GScholarScraper.R
# Date: 2019-04-19
# Original creator: Kay Cichini
# Adapted by: Alison Henry
# Email: alisontaylorhenry@gmail.com
# Purpose: Scrape Google Scholar search results
# Packages used: XML
# Licence: CC BY-SA-NC
#
# Arguments:
...
#
# (3) since: define year since when publications should be returned..
# defaults to 1900..
#
# (4) citation: logical, if "1" citations are included
# defaults to "0" and no citations will be included..
#
# Caveat: returns error message if a submitted search string finds more than 1000 hits 
#
